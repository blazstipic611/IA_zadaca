...
to setup
  ...
  ;; postavljaju se "stijene" u ukruženju
...
;;to stoplight  ;; funkcija semafora
;;  ifelse ticks mod 100 > 50
;;    [ ask patch 6 6 [ set pcolor green ] ] ;; svakih 50 tickova mijenja se svjetlo
...
@#$#@#$#@
## OPIS PRIMJERA
UPonovno je i u ovom primjeru opisan rad dva agenta koji upravljaju roverima na Marsu čiji je zadatak prikupljanje uzoraka pronađenih stijena. Pri tome, nakon što jedan agent prikupi uzorak, ne ostaje dovoljno stijene da uzorak prikupi i drugi agent. 

## VRSTA INTERAKCIJE
Ovo je situacija u kojoj agenti imaju kompatibilne ciljeve i dovoljno sposobnosti za ostvarivanje tih ciljeva, međutim resursi u okruženju nisu dostatni za sve agente.
Ovaj tip interakcije je opstrukcija. Ona je je karakteristična za sve situacije u kojima agenti ne trebaju jedni druge za realiziranje zadataka, ali utječu na izvedbu ostalih agenata.
@#$#@#$#@
default
true
0
