...
to setup
  ...
  ;; postavljaju se "stijene" u okruženju
...
@#$#@#$#@
## OPIS PRIMJERA
U ovom primjeru je opisan rad agenata koji upravljaju roverima na Marsu čiji je zadatak prikupljanje uzoraka pronađenih stijena. Roveri se kreću unaprijed definiranim putanjama i ukoliko naiđu na stijenu uzimaju njen uzorak. 

## VRSTA INTERAKCIJE
Ciljevi agenata su kompatibilni, svaki od njih ima potrebne vještine za ostvarivanje tih ciljeva, a količina raspoloživih resursa u okruženju je dovoljna za sve agente.
Ovaj tip interakcije je neovisnost. Tu se radi o neutralnoj situaciji koja ne zahtijeva bilo kakvu specifičnu interakciju.
@#$#@#$#@
default
true
0
