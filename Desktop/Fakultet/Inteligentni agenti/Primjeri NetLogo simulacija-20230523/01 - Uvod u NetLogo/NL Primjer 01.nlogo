; sve iza znaka ; je komentar NetLogo programa koji kompajler ne uzima u obzir
...
to go
  ...
  ask turtles          ; svi agneti izvode radnji koji slijede u bloku
  [                    ; početak bloka
    fd 1                 ; agenti se pomiču ja jediničnu dužinu unaprijed
    set heading (heading - (angle / 2) + random(angle))
                         ; mijenja se usmjerenje agenta u ovisnosti o slučajnom broju (random) globalne varijable angle
  ]                    ; kraj bloka
end
@#$#@#$#@
GRAPHICS-WINDOW
