...
to setup
  ...
  create-turtles 5       ;; kreira se 5 agenata (vozila)
...
## VRSTA OKRUŽENJA
Po kriteriju **dostupnosti informacija** ovo okruženje je **potpuno osmotrivo** jer sustav senzora agentu daju puni pristup cjelokupnom stanju okruženja

U ovom primjeru radi se samo o svjetlu na semaforu.  
