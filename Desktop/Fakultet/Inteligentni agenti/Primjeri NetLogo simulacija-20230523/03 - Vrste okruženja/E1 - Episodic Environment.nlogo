globals [ new-products products badx bady]
...
to setup
  ...
  set products 0         ;; postavlja broj dovrsenih proizvoda na 0
  set badx 6
...
to go
  ...
  if (products = 30)     ;; nakon serije od 30 proizvoda
  [
    show "End of Product Series"
    ask patch 6 6
    [
...
to walk                  ;; funkcija pomicanja proizvoda po traci
  ...
  [
    ifelse xcor = 6      ;; ako je proizvod dosao so kraja trake
    [
      set products products + 1
                         ;; broji se dovrseni proizvod
      ifelse color = red
...
Seriju proizvoda čini 30 proizvoda i simulacija se prekida kada do kraja trake dođe 30 proizvoda, bez obzira koliko je bilo neispravnih proizvoda. 

## VRSTA OKRUŽENJA

Po kriteriju **epizodičnosti** ovo okruženje je **epizodično** jer buduće odluke agenta ne ovise o akcijama koje je agent prethodno poduzeo, nego samo o informacijama dobivenim putem senzora o stanju u kojem se okruženje nalazi.

U ovom primjeru registira se ispravnost / neispravnost proizvoda, ne vodeći računa kakvi su rezultati bili prije toga.  
