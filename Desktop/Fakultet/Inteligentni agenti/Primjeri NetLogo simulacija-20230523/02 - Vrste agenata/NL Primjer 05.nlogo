to setup
  ...
  ask n-of 15 patches [ set pcolor gray ]
...
Primjer simulira rad jednostavnog reaktivnog agenta koji upravlja usisavačem i reagira samo na trenutni podražaj, tj. postojanje prljavštene na poziciji na kojoj se trenutno nalazi, ne vodeći računa o prethodnim opažanjima. 
...
Funkcija _**clean**_ simulira provjeru zaprljanosti prostorije na poziciji na kojoj se usisavač trenutno nalazi (_siva boja_) i njeno čišćenje realizirano bojanjem tog dijela prostorije u _crnu boju_.
Funkcija _**move**_ simulira kretanje usisavača od donjeg lijevog ka gornjem desnom kutu, pričemu obilazi sve dijelove okruženja. Simulacija se zaustavlja u trenutku kad usisavač dođe u gornji desni kut modela. 
