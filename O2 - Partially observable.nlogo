...
to walk                  ;; funkcija kretanja vozila (agentska funkcija)
  ...
  [
    ...
    [
        ...
        ifelse [pcolor] of patch xcor (ycor - 1) = grey and (not any? obstacles-on patch xcor (ycor - 1))
         [
              setxy xcor (ycor - 1)
         ]
         [
              if [pcolor] of patch xcor (ycor + 1) = grey and (not any? obstacles-on patch xcor (ycor + 1))
              [
                  setxy xcor (ycor + 1)
              ]
         ]
